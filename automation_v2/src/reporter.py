...
from src.config import LOGGING_SHEET_ID, ACTIVITY_LOG_SHEET_NAME, RECIPIENT_EMAIL
import base64
...
def fetch_daily_activity():
    ...
    spreadsheet_id = LOGGING_SHEET_ID
    range_name = f'{ACTIVITY_LOG_SHEET_NAME}!A:F'
